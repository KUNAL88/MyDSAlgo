...
Write a solution to report the number of cubic feet of volume the inventory
...
from (
    select w.name as warehouse_name, w.units * p.Width * p.Length * p.Height as volume
from Warehouse as w join Products as p
